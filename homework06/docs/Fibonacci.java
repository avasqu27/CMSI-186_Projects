...
public class Fibonacci {
   ...
   public static void main( String[] args ) {
     ...
     // NOTE: this section is just a happy notification that lets the user know to be patient.......
      ...
      maxCount = Integer.valueOf(args[0]);
      BrobInt firstfib = new BrobInt("0");
      BrobInt secondfib = new BrobInt("1");
      BrobInt currentfib = new BrobInt("1");
      for (int i = 2; i < maxCount; i++) {
        if( maxCount > working ) {
           System.out.println( "\n                This may take me a while; please be patient!!\n\n" );
        }
        currentfib = firstfib.addByte(secondfib);
        firstfib = secondfib;
        secondfib = currentfib;
      }

      System.out.println( "\n\n\n  Fibonacci is: " + String.valueOf(currentfib) + "*grins*" );
